...
function HOMEINITTEMPLATE ($, undefined) {
    ...
    function promo_slider_1items() {
        var $slider = $('.promo-slider-1items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                slidesToShow: 1,
    ...
    function top_infobar_slider() {
        var $slider = $('.infobar-slider-4items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                slidesToShow: 4,
    ...
    function topbar_slider_style1() {
        var $slider = $('.topBar-slider-style1');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                slidesToShow: 1,
    ...
    function category_image_items() {
        var $slider = $('.category-image-3items');
        if ($slider.length) {
            $slider.slick({
                dots: true,
                infinite: true,
    ...
    function collection_slider_3items() {
        var $slider = $('.collection-slider-3items');
        if ($slider.length) {
            $slider.slick({
                dots: true,
                infinite: true,
    ...
    function image_slider3items() {
        var $slider = $('.image-text-slider3items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                infinite: true,
    ...
    function collection_slider_4items() {
        var $slider = $('.collection-slider-4items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                infinite: true,
    ...
    function collection_slider_5items() {
        var $slider = $('.collection-slider-5items');
    ...
    function collection_slider_6items() {
        var $slider = $('.collection-slider-6items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                infinite: true,
    ...
    function product_slider_3items() {
        var $slider = $('.product-slider-3items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                infinite: true,
    ...
    function product_slider_4items() {
        var $slider = $('.product-slider-4items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                infinite: true,
    ...
    function product_slider_5items() {
        var $slider = $('.product-slider-5items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                infinite: true,
    ...
    function testimonial_slider_1items() {
        var $slider = $('.testimonial-slider-1items');
        if ($slider.length) {
            $slider.slick({
                dots: true,
                infinite: true,
    ...
    function testimonial_slider_2items() {
        var $slider = $('.testimonial-slider-2items');
        if ($slider.length) {
            $slider.slick({
                dots: true,
                infinite: true,
    ...
    function testimonial_slider_3items() {
        var $slider = $('.testimonial-slider-3items');
        if ($slider.length) {
            $slider.slick({
                dots: true,
                infinite: true,
    ...
    function instagram_slider_5items() {
        var $slider = $('.instagram-slider-5items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                infinite: true,
    ...
    function service_slider_4items() {
        var $slider = $('.service-slider-4items');
        if ($slider.length) {
            $slider.slick({
                dots: false,
                infinite: true,
    ...
    function service_slider_5items() {
        var $slider = $('.service-slider-5items');
        if ($slider.length) {
            $slider.slick({
                dots: true,
                infinite: true,
    ...
    function product_thumb1() {
        var $slider = $('.product-thumb-horizontal');
        if ($slider.length) {
            $slider.slick({
                infinite: true,
                slidesToShow: 5,
    ...
    function product_thumb() {
        var $slider = $('.product-thumb-vertical');
        if ($slider.length) {
            $slider.slick({
                infinite: true,
                slidesToShow: 5,
...
function actionNetxCheckout(params) {
...
function cleanupSliders($) {
    ...
    $('.product-slider-5items').each(function() {
        if ($(this).hasClass('slick-initialized')) {
          $(this).slick('unslick');
        }
    });
    $('.weekly-product').each(function() {
        if ($(this).hasClass('slick-initialized')) {
            $(this).slick('unslick');
        }
    });
...
function collectionSlider4items() {
    var $slider = $('.collection-slider-4items');
    if ($slider.length) {
        $slider.slick({
            dots: false,
...
window.collectionSlider4items= productSlider5items;
